...
export default function useHotKeys(props, listeners = []) {
    const clicked = {}, target = typeof props.focusTarget === "string" ? document.getElementById(props.focusTarget) : props.focusTarget
    const { setAllShortcuts, setActiveWindow, activeWindow } = useContext(HotKeysProvider)
